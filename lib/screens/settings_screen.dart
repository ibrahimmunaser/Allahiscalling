                ...
                ListTile(
                  ...
                  onTap: () => _pickEnum<AsrMethod>(
                    ...
                    onSelected: (v) => controller
                        .updateSettings(settings.copyWith(asrMethod: v)),
                  ),
                ),
                const Divider(height: 1),
                ListTile(
                  ...
                  trailing: const Icon(Icons.chevron_right),
                  onTap: () => _pickEnum<HighLatitudeRuleOption>(
                    context: context,
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () => _pickEnum<int>(
                    ...
                    labelOf: (v) => '$v minutes',
                    onSelected: (v) => controller
                        .updateSettings(settings.copyWith(snoozeMinutes: v)),
                  ),
                ),
                if (!controller.notificationsPermitted) ...[
                  ...
                  ListTile(
                    ...
                    subtitle:
                        const Text('Tap to request notification permission'),
            ...
            child: ListTile(
              ...
              trailing: Row(
                ...
                children: [
                  IconButton(
                    icon: const Icon(Icons.remove_circle_outline),
                    onPressed: settings.hijriAdjustmentDays <= -2
                        ? null
